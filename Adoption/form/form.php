...
if(isset($_POST['submit'])){
 ...
 $sqlQuery="INSERT INTO `adopt` (`dog_image`, `dog_name`, `dog_breed`, `dog_age`, `dog_gender`, `dog_color`, `dog_size`, `describ`, `location`, `owner_name`, `owner_email`, `owner-number`)values('$dog_image','$dog_name','$dog_breed','$dog_age','$dog_gender','$dog_color','$dog_size','$describ','$location','$owner_name','$owner_email','$owner_number')";
